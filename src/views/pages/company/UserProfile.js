...
// ** Demo Components
import Account from 'src/views/pages/company/account';
import Profile from 'src/views/pages/company/profile';
...
import UserProfileHeader from 'src/views/pages/company/UserProfileHeader';
