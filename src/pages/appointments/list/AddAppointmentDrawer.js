...
import { addAppointment, fetchData, setAppointments } from 'src/store/apps/appointment'
...
const SidebarAddAppointment = props => {
  // ** Props
  ...
  const submit = async data => {
    const response = await axiosCall.post(allURL.APPOINTMENTS, data);
...
export default SidebarAddAppointment
