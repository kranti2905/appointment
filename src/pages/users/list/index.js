...
// ** Actions Imports
import { fetchData, deleteUser, setUserEdit, setUsers } from 'src/store/apps/user'
  ...
  return (
    <>
      ...
      >
        ...
        <MenuItem component={Link} href={'/users/view/account?id=' + id} onClick={handleRowOptionsClose} sx={{ '& svg': { mr: 2 } }}>
